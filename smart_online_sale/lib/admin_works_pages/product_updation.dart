...
class _ProductUpdationScreenState extends State<ProductUpdationScreen> {
  ...
  @override
  void didUpdateWidget(covariant ProductUpdationScreen oldWidget) {
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        //     children: widget.productValue!.imageUrl
                        //         .map(
                        //           (e) => Stack(
                        //             children: [
                        //               Image.network(e),
                        //               Consumer<MultiImageProvider>(
                        //                 builder: (context, mIPe, child) =>
                        //                     IconButton(
                        //                         onPressed: () {},
                        //                         icon: const Icon(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () => _addProductOnFirebase(
                          context,
                        ),
                        style: ButtonStyle(
